...
<section class="content">
    <div class="box box-default" style="padding: 10px 10px 10px 10px">
        ...
        <table id="psuser-dt-table" class="table display compact table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th></th>
                    <th>Id</th>
...
<!-- Bootstrap modal -->
<div class="modal fade" id="psuser-fm-modal" role="dialog" data-keyboard="false" data-backdrop="static">
                ...
                <div class="modal-body form" style="max-height: 400px; overflow-y:auto">
                    ...
                    <div class="form-body" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select id="psuser-role-select" name="urole" class="form-control">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        //////////////////////////////////////////////////////////////////////////////////////////////
        $.getJSON("<?php echo base_url('role/psrole_list_combo'); ?>", function(data) {

            $.each(data, function(key, value) {
                $('#psuser-role-select').append(
...
//////////////////////////////////////////////////////////////////////////////////////////////
        //datatables
        psuser_dt_table = $('#psuser-dt-table').DataTable({
            "processing": true, //Feature control the processing indicator.
            "serverSide": true, //Feature control DataTables' server-side processing mode.
            "order": [], //Initial no order.
            // Load data for the table's content from an Ajax source
            "ajax": {
                "url": "<?php echo base_url('usermanager/psuser_list') ?>",
                "type": "POST"
            },
            "columns": [
                {data: 'sl'},
    ...
    function newUser() {
        ...
        $('#user-modal .clone-form').bootstrapValidator({
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url('usermanager/new_psuser'); ?>',
                cache: false,
                data: $form.serialize(),
                dataType: 'json',
                beforeSend: function() {
...
///////////////////////////////////////////////////////////////////
    ...
    function editUser(row) {
        var data = psuser_dt_table.row(row).data();
        if (data) {
            if ($('#user-modal').length) {
                $('#user-modal').remove();
            }
            ...
            $('#user-modal .clone-form').bootstrapValidator({
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url('usermanager/edit_psuser'); ?>',
                    cache: false,
                    data: $form.serialize(),
                    dataType: 'json',
                    beforeSend: function() {
...
///////////////////////////////////////////////////////////////////
    ...
    function reloadUser() {
        psuser_dt_table.ajax.reload(null, false); //reload datatable ajax
    }
